...
; export symbols
            XDEF Entry, _Startup, disp, start_f,flag,homeflag,screen_sel,syst_set_f,passv2, PW_Verify2
            XDEF command,port_t,LCD_timer1,LCD_timer2,go_home
            XDEF port_u, delay
            ...
            XREF Door_Song, Song_Start, sound_rdy,  tone_count, sound_c,PW_Verify_String2,Password_verify2
            XREF GenSel,Date_Change, Time_Change, SONG_TIME_START, Song, Cont_Men, MENU, clearv,loading_c_menu
...
go_back:		clr	go_home			;reset go home flag				             													
			jsr 	MENU					  ;Shows MW output and time, (HOME SCREEN)
