...
switch_input:
      ...
      beq   change      ;branch if switch values have changed
      
      staa  check       ;store current switch value
...
change:     movb  #1,switch_f       ;indicates a switch has been flipped
